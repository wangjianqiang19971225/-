...
Page({
  data: {
    ...
    city: "",
    code:"",
    hotcityList: [{ cityCode: 110100, city: '北京市' }, { cityCode: 370200, city: '青岛' }],
    inputShowed: false,
    inputVal: "",
    completeList:[]
  },
  ...
  updateAppCity(cityId){
    ...
    if(app.citySelect.provriceId==370000||app.citySelect.provriceId==110000){
      wx.switchTab({
      url: '../index/index'
    })
    }else{
    ...
    console.log(app.citySelect.cityId)
    console.log(app.citySelect.provriceId)
  },
